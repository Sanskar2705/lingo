...
try:
    ...
    original_data= pandas.read_csv("data/farsi.csv")
...
def next_card():
    ...
    canvas.itemconfig(card_title, text= "Persian", fill= "black")
    canvas.itemconfig(card_word, text=current_card["Persian"] , fill= "black")
